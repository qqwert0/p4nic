...
class AlveoStaticIO(VIVADO_VERSION:String, QDMA_PCIE_WIDTH:Int, QDMA_SLAVE_BRIDGE:Boolean, QDMA_AXI_BRIDGE:Boolean) extends Bundle {
    val sysClk      = Output(Clock())
    val cmacPin     = Flipped(new CMACPin())
